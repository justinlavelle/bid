...
<div class="filterBox" style="display: none">
	...
	<fieldset>
		<?php echo $form->input('mobivi',array ('type' => 'checkbox','label' => 'Mobivi', 'checked' => 1));?>
		<?php echo $form->input('nganluong',array ('type' => 'checkbox', 'label' => 'Ngân Lượng', 'checked' => 1));?>
		<?php echo $form->input('icoin',array ('type' => 'checkbox', 'label' => 'icoin', 'checked' => 1));?>
