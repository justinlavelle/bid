...
<div id="menu" style="background: #718145 url(<?= $this->webroot ?>img/ban/guest_ban/head_ban_guest_bg.png) repeat-x scroll left top;">
	...
	<!-- Left Ban -->
	<div class="guest_l1">
	<img src="<?php echo $this->webroot; ?>img/ban/guest_ban/head_ban_guest_copy.png" width="465" height="170" alt="The ultimate new shopping experience" title="The ultimate new shopping experience">
