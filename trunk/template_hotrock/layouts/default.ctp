...
<head>
	...
	<?php
		...
		//echo $javascript->link('http://localhost:5050/socket.io/socket.io.js');
		//echo $javascript->link('http://localhost:5050/socket.io/socket.io.extra.js');
		//echo $javascript->link('http://localhost:5050/sio.js');
		echo $javascript->link('json2');
		echo $javascript->link('apps');
		echo $javascript->link('jquery/jquery.validate.min.js');
		
		//echo $javascript->link('ape-jsf/ape');
...
<body id="body">
	<a id='idle' class='thickbox' href="/idle.htm?height=160&width=295" style='display:none'> idle </a>
	<a id='serverError' class='thickbox' href="/error.htm?height=160&width=295" style='display:none'> idle </a>
