...
&nbsp;<?php echo sprintf(__('%s bids left', true), '<strong>'.$bidBalance.'</strong>');?>
    </ul>
<?php else:?>
    <ul>
...
<div class="user-status"><span class="side_5px bold" style="margin-right:8px;"><img src="<?php echo $appConfigurations['ref_url']; ?>/img/parts/guide_head_icon.png" width="21" height="21" border="0" alt="" style="margin-right:4px; margin-top:-2px;" align="middle"><a href="<?php echo $appConfigurations['nml_url']; ?>/page/about" style="color:#FFF;">About Us</a></span><span class="head_help"><a href="<?php echo $appConfigurations['nml_url']; ?>/page/help" style="font-weight:normal; color: #FFF;">Help</a></span></div>
<?php endif;?>
</div>