...
<div style="font-size:12px; margin-bottom:15px;"><span class="required">*</span> denotes mandatory field.</div>
		<?php
			...
			echo $form->input('brief', array('class' => 'mceEditor', 'label' => 'Brief <span class="HelpToolTip"><img src="/admin/img/help.png" alt="" border="0" /><span class="HelpToolTip_Title" style="display:none;">Brief description to show on some pages</span><span class="HelpToolTip_Contents" style="display:none;">This section will show on the homepage, on some templates, and provides a snippet of text to give a better understanding of what the product is about before it is clicked.</span></span>'));
		?>
		...
		<label for="PageContent"><?php __('Specification');?></label>
		<?php echo $form->input('Product.specification', array('class' => 'mceEditor')); ?>
		<p>&nbsp;</p>
		
		<label for="PageContent"><?php __('Warranty');?></label>
		<?php echo $form->input('Product.warranty', array('class' => 'mceEditor')); ?>
		<p>&nbsp;</p>
		...
		<?php
			...
			if(!empty($appConfigurations['freeAuctions'])) :
				echo $form->input('free', array('label' => 'Make this a Free Auction? <span class="HelpToolTip" style="float: none;"><img src="/admin/img/help.png" alt="" border="0" /><span class="HelpToolTip_Title" style="display:none;">Allow free bidding for users</span><span class="HelpToolTip_Contents" style="display:none;">Check this box to make this product always function as a free product. It will cost nothing for your users to bid. Ideal for promotional items such as t-shirts with your website or company name on.</span></span>'));
			endif;
			...
			echo $form->input('delivery_information', array('class' => 'mceEditor', 'label' => 'Delivery Information <span class="required">*</span>  <span class="HelpToolTip"><img src="/admin/img/help.png" alt="" border="0" /><span class="HelpToolTip_Title" style="display:none;">Delivery Information</span><span class="HelpToolTip_Contents" style="display:none;">Optional data that will be showed to all visitors of your auction page. Helpful to specify your delivery timeframes, ie \'delivery within 5 working days to mainland USA\'.</span></span>'));
