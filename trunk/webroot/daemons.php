...
//uncomment the next line and change its full path to enable detailed daemon logging
//$log_file='/www/phppa/tmp/logs/daemons.log';  
...
switch($_GET['type']){
	case 'bidbutler':
		mysql_query("INSERT INTO logs(type) VALUES ('bitbutler')");
	...
	case 'close':
		mysql_query("INSERT INTO logs(type) VALUES ('close')");
