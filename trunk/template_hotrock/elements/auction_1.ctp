<div class="auction-type-1 auction-item" id="auction_<?php echo $auction['Auction']['id'];?>" title="<?php echo $auction['Auction']['id'];?>">
	...
	<div class="auction-time"> 12 : 00 : 00 </div>
	...
	<div class="auction-bidder-container">
		Người đấu : <span class="auction-bidder"><?php echo $auction['LastBid']['username']?></span>
	</div>
	<div class="auction-rrp-container">
		Mua ngay : <span class="auction-rrp money"><?php echo $auction['Product']['rrp']?></span> VNĐ
	</div>
