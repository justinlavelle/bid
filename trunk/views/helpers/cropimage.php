...
class CropimageHelper extends Helper {
            ...
            return $this->output("<script type=\"text/javascript\">
                ...
                $(document).ready(function () {
                    $('#save_thumb').click(function() {
                        ...
                        var h = $('#h').val();
                        if(x1==\"\" || y1==\"\" || x2==\"\" || y2==\"\"|| w==\"\" || h==\"\"){
                            alert('Làm ơn chọn vùng muốn sử dụng làm avatar');
                            return false;
                        }else{
                            return true;
                    }
    ...
    function createForm($imagePath, $tH, $tW){
        $x1 =         $this->Form->hidden('x1', array("value" => "", "id"=>"x1"));
            ...
            $imgTumPrev = $this->Html->image($imagePath, array('style'=>'position: relative;', 'id'=>'thumbnail_prev', 'alt'=>'Thumbnail Preview'));
            return $this->output("
            <div class=\"module\">
            <div class=\"imgwrapper\" style=\"position:relative; overflow:hidden; width:".$tW."px; height:".$tH."px;\"> 
                $imgTumPrev
            </div>
            <div class=\"blah\">
            Xin hãy khoanh vùng ảnh bạn muốn sử dụng làm hình đại diện phia bên dưới.<br/>
            <input type=\"submit\" id=\"save_thumb\" value=\"Cập nhập\">
            </div>
            </div>
